...
update route set machine='machine1' where from_city_id>=1 and from_city_id<=3;
update route set machine='machine2' where from_city_id=4 or from_city_id=15 or from_city_id=16;
update route set machine='machine3' where from_city_id=5;
update route set machine='machine4' where from_city_id=6;
update route set machine='machine5' where from_city_id=7;
update route set machine='machine6' where from_city_id=8;
...
update route set machine='machine2' where id >32 and id <=64;
update route set machine='machine3' where id >64 and id <=96;
update route set machine='machine3' where id >96 and id <=128;
update route set machine='machine3' where id >128 and id <=160;
update route set machine='machine3' where id >160 and id <=192;
update route set machine='machine3' where id >160 and id <=192;
update route set machine='machine3' where id >160 and id <=192;
update route set machine='machine3' where id >160 and id <=192;
update route set machine='machine3' where id >160 and id <=192;
