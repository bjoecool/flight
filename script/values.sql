...
insert into airline values(nextval('airline_id'),4,5);
insert into airline values(nextval('airline_id'),4,6);
insert into airline values(nextval('airline_id'),4,7);
insert into airline values(nextval('airline_id'),4,8);
insert into airline values(nextval('airline_id'),4,9);
...
insert into airline values(nextval('airline_id'),5,4);
...
insert into airline values(nextval('airline_id'),6,4);
...
insert into airline values(nextval('airline_id'),7,4);
...
insert into airline values(nextval('airline_id'),8,4);
